...
class JinjaHandler(object):
    ...
    def __init__(self,testsets_name,success_rate,raw_reports=list(),test_type="endpoint"):
    ...
    def _jinja_replace_underscore_with_space(self,key):
        newkey = " ".join(key.split("_"))
        return newkey
    ...
    def register_jinja_filters(self,env):
        ...
        env.filters['underscore2space'] = self._jinja_replace_underscore_with_space
        return env