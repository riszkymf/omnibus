...
def run_testsets(testsets):
    ...
    for testset in testsets:
        ...
        for test in mytest:
            ...
            if myconfig.is_reported:
                ...
                myreport = list()
            result,report_results = run_test(test,test_config=myconfig,context=context,request_handler=requests_handler,reports=myreport)
    ...
    util.generate_file('/home/mfriszky/sketchbook/omnibus/omnibus/runcov/test_report.html',text)
